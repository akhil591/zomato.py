from zomato.commands.cart import display
from zomato.services.cart import CartService
from zomato.models import Cart, Order
from rich.console import Console
from rich.table import Table
from zomato.exceptions import zomatoExit
...
class OrderService:
    ...
    def checkout(self, user, amount):
        ...
        if orders.count() == 0:
            raise zomatoExit("Place your order before checking out!")
        ...
        if amount < total_price:
            raise zomatoExit("Insufficient balance")
    ...
    def history(self, user):
        ...
        if orders.count() == 0:
            raise zomatoExit("You have not bought anythin yet.")
