"""
This file contains database models for the  zomato  app.
...
# Database connection
db = SqliteDatabase("zomato.db", pragmas={"foreign_keys":1})
...
class Food(Model):
    ...
    def availability(name: str, quantity: int):
        ...
        if item.quantity < quantity:
            raise zomatoExit(f"Only {item.quantity} {name} available.")
        return item
